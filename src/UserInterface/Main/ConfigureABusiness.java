...
//        SolutionOrder so = msol.newSolutionOrder(solutiontvteen, np, c,s);
...
// Create Customers
        CustomerDirectory customedirectory = business.getCustomerDirectory();
        CustomerProfile customer1 = customedirectory.newCustomerProfile(person1, market1, channel1);
        CustomerProfile customer2 = customedirectory.newCustomerProfile(person2, market1, channel2);
        CustomerProfile customer3 = customedirectory.newCustomerProfile(person3, market2, channel1);
        CustomerProfile customer4 = customedirectory.newCustomerProfile(person4, market2, channel2);
...
// Create Sales people
        ...
        SolutionOrder solOrder2 = masterSolution.newSolutionOrder(solOffer1, 30000, customer2, salesPerson1);
