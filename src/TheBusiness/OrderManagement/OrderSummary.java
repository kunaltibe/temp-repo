...
public class OrderSummary {
    ...
    public String toString() {
        return "OrderSummary{" + "subjectorder=" + subjectorder + ", salesvolume=" + salesvolume + ", totalabovetarget=" + totalabovetarget + ", orderpriceperformance=" + orderpriceperformance + ", numberofOrderitemsabovetarget=" + numberofOrderitemsabovetarget + ", numberofOrdeitemsbelowtarget=" + numberofOrdeitemsbelowtarget + '}';
    }
