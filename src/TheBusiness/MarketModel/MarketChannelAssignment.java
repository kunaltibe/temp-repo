...
public class MarketChannelAssignment {
    ...
    public MarketChannelAssignment (String marketName) {
        Market mar = new Market(marketName);
        this.market = mar;
    ...
    public String toString() {
        return "MarketChannelAssignment{" + "market=" + market + ", channel=" + channel + ", adbudget=" + adbudget + '}';
    }
